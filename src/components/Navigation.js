...
const Navigation = () => {
  ...
  return (
    <Section id="navigation">
      <NavBar>
        <Logo /> <span>by <img src={SemproLogo} style={{width:"50%", height:"15px"}} alt="fireSpot"/></span>
        ...
        <Menu click={click}>
          ...
          <MenuItem onClick={() => scrollTo("about")}>Treasury</MenuItem>
          ...
          <MenuItem onClick={() => scrollTo("showcase")}>Artist Showcase</MenuItem>

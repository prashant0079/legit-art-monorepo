    ...
    <Section id="roadmap">
      ...
      <Container>
        ...
        <Items>
          ...
          <RoadMapItem
            addToRef={addToRefs}
            title="Launching LegitArt.DAO Website"
            subtext="The upcoming phase includes the launch of LegitArt.DAO, an
          ...
          <RoadMapItem
            ...
            subtext="LegitArt aims to introduce a staking mechanism as an additional feature,
          ...
          <RoadMapItem
            addToRef={addToRefs}
            title="Launch of Cryptocurrency Token"
            subtext="LegitArt envisions the launch of its own cryptocurrency token
          ...
          <RoadMapItem
            ...
            subtext="LegitArt recognizes the importance of collaborations and

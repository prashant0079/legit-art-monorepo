  ...
  return (
    <div className="p-8">
      ...
      <p>
        ...
        Your contributions towards LegitART NFTs:{' '}
        <span>
          <strong>{mybalance} Eth</strong>
          {isStakeholder ? ', congratulations, you are now a stakeholder' : null}
        </span>
      </p>
      ...
      <p>
        {isStakeholder
          ...
          : 'Hey, when you purchase a LegitART NFT, you become a stakeholder'}
      </p>
